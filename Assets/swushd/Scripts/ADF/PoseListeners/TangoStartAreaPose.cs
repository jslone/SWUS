...
/// </summary>
public class TangoStartAreaPose : MonoBehaviour, ITangoLifecycle, ITangoPose
{
    /// <summary>
    ...
    public void OnTangoPoseAvailable(TangoPoseData pose)
    {
		...
		if (pose.framePair.baseFrame == TangoEnums.TangoCoordinateFrameType.TANGO_COORDINATE_FRAME_START_OF_SERVICE
			&& pose.framePair.targetFrame == TangoEnums.TangoCoordinateFrameType.TANGO_COORDINATE_FRAME_AREA_DESCRIPTION)
		{
